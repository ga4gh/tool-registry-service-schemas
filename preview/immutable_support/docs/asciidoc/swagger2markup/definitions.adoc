...
|**hashcode** +
__optional__|Helpful for immutable tool versions, but can be useful in other cases as well. This exposes a hashcode for specific files to verify whether the file has changed.|string
|**url** +
