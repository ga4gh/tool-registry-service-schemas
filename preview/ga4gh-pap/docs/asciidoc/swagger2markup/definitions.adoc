...
[[_serviceinfo]]
=== ServiceInfo
Describes this registry to better allow for mirroring, indexing, and useful information about the running service, including supported versions and default settings..
...
|**contact_info_url** +
__required__|An email address URL (mailto:) or web page URL with contact information for the operator of a specific TRS endpoint. Users of the endpoint should use this to report problems or security vulnerabilities.|string
|**country** +
